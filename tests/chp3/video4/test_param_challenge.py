...
@pytest.mark.parametrize("country,stat,val", [('Andorra', 'Mean', 1641.42),('Andorra', 'Median', 1538.02),('Argentina', 'Median', 125.0)])
def test_csv_writer(process_data, country,stat,val):
    """
